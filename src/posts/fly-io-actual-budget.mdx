...
_(Note: The format is <kbd>fly wireguard create [org] [region] [name] [file]</kbd>. Configure accordingly to your preferred region and names)._
...
<lite-youtube videoid="Ogco4OAboxs" playlabel="Hosting Personal Apps Securely on Fly.io: Actual Budget Example - Demo Video"></lite-youtube>
...
<lite-youtube videoid="qSkUVymTT-w" playlabel=" Hosting Personal Apps Securely on Fly.io: Actual Budget Example - Mobile Demo Video "></lite-youtube>
